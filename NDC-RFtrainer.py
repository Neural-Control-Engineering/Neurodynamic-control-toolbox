...
X = np.array([get_features(row[:-1]) for row in matrix])
y = matrix[:, -1]
...
feature_names = [
    'IEMG', 'MAV', 'SSI', 'RMS', 'VAR', 'WL', 'DAMV', 'M2', 'DVARV', 'DASDV', 'MAX', 'MIN', 'IASD', 'IATD', 'IEAV', 'IE', 'SKEW', 'KURT'
]
