function [neuropixel_to_process] = fetchNeuropixel2Extract(animal_id,session_names,paths,reset_neuropixel_processing)
...
neuropixel_list = neuropixel_list(contains(neuropixel_list,".mat") & contains(neuropixel_list,animal_id));
