function [behavior] = fetch_phase_II_behavior(Data,start_buffer,end_buffer)
...
% Optogenetic details
behavior.pulse.rise_times =  Data.Data.CameraTrig.data(diff(Data.Data.CameraTrig.data(:,3)) > 0,5)-start_buffer;
