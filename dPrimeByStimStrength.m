function dPrimeByStimStrength(data)
    ...
    errorbar(stim_strengths(2:end) .* 10, nanmean(dp), nanstd(dp) ./ sqrt(length(animals)), 'color', 'k', 'linewidth', 2, 'DisplayName', sprintf('Mean \x00B1 SEM: (N_{animals}=%i)', length(animals)))
