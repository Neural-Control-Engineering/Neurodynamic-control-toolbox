function fig7c_alt(data, k, data_ver, ssd_version, psychver, animals)
...
function lumpByResponseProb(data_ver, ssd_version, psychver, animals, data, k)
    ...
    saveas(fig_bar, 'Figures/fig7c_alt_bar.fig')
    saveas(fig_bar, 'Figures/fig7c_alt_bar.svg')
    saveas(fig_dot, 'Figures/fig7c_alt_dot.fig')
    saveas(fig_dot, 'Figures/fig7c_alt_dot.svg')
    % leg = legend()
